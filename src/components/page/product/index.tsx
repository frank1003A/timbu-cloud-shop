  ...
  return (
    <main>
      <section className="px-4 lg:px-[120px] py-10 md:py-12">
        ...
        <main className="grid grid-cols-1 lg:grid-cols-2 w-full mt-16">
          {/** Image Section */}
          <div className="lg:w-full mt-10 lg:mt-0 mb-10 md:mb-0">
            <div className="flex flex-col h-full items-center md:border  rounded-xl">
          ...
          {/** Content Section */}
          <div className="lg:w-full sticky top-0 right-0 px-0 md:px-10">
            <div className="w-full flex flex-col gap-4">
              ...
              <h2 className="text-[#141718] text-2xl">{activeProduct.name}</h2>
