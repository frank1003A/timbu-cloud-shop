...
const WishListPage = () => {
  ...
  const removeItemFromCart = (id: string) => {
    ...
    toast({
      variant: "destructive",
      title: `Product ${id} removed from WishList`,
    });
  };

  return (
    <main>
      <section className="px-2 lg:px-[120px] py-10 md:py-12">
        ...
        {wishList && wishList.length > 0 ? (
          <main>
            <div className="flex flex-col mt-8 text-center gap-2 text-[#161D25]">
              ...
              <h1 className=" font-medium text-4xl">Wish List</h1>
            </div>
          ...
          <div className="w-full h-full py-20 flex flex-col gap-5 items-center justify-center">
